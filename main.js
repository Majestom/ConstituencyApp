...
const myJSON = loadData("ge_2019_constituencies.json");
	...
	function populateData() {
		if (httpRequest.readyState === XMLHttpRequest.DONE) {
			...
			if (httpRequest.status === 200) {
				...
				console.log("The following is consData.")
				console.log(consData);

				// Start of section copied from outside this if statement.
				...
				function createCircles(someJSON) {

					console.log("The following is JSON!");
					console.log(someJSON);
					console.log("The following is hexes E14000530!");
					console.log(someJSON.E14000530);
				...
				// End of section copied from outside this if statement.
